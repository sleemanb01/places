export const ERROR_INVALID_DATA = "Could not find an item for the provided data";
export const ERROR_INVALID_INPUTS = "invalid inputs passed, please check your data!";
